...
class AtHomeAerobic{
    ...
    this.TypeAerobic=" At Home Aerobic that will included: Jump rope, Aerobic \nstrength circuit & many more";
...
class AtGymAerobic{
    String TypeAerobic,benefits1, benefits2, equipment1;
    ...
    this.benefits1="Swimming is a low-impact exercise, so it’s good for people prone to or recovering from an injury or living with limited mobility. It can help you tone your muscles and build strength and endurance.";
